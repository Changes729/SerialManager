...
def main():
    # serial_device_list = os.popen("python ./tools/find_serial_com.py --des Projector --db ./test/location_db.csv").read().split(' ')
    serial_device_list = os.popen("python ./tools/find_serial_com.py --des Arduino").read().split(' ')
